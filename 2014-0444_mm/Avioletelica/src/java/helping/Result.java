...
public class Result {
    ...
    public Result(int ID, String start_city, String end_city, String end_country, String start_country, String start_air, String end_air, String duration, Date start_date, int free,Time start_time) {
        this.ID = ID;
